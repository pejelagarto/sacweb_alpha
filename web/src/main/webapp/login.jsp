...
<c:if test="${param.error != null}">
    ...
    <input type="text" name="j_username" id="j_username" class="form-control input-sm"
           placeholder="<fmt:message key="label.username"/>" required tabindex="1">
    <input type="password" class="form-control input-sm" name="j_password" id="j_password" tabindex="2"
...
<c:if test="${appConfig['rememberMeEnabled']}">
    ...
    <button type="submit" class="btn btn-lg btn-primary btn-block btn-sm" name="login" tabindex="4">
