...
<div class="col-sm-7">
    ...
    <form:form commandName="user" method="post" action="userform" id="userForm" autocomplete="off"
        ...
        <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
            ...
            <form:input cssClass="form-control input-sm" path="username" id="username"/>
        ...
        <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
            ...
            <form:input cssClass="form-control input-sm" path="passwordHint" id="passwordHint"/>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
                ...
                <form:input cssClass="form-control input-sm" path="firstName" id="firstName" maxlength="50"/>
            ...
            <div class="col-sm-6 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
                ...
                <form:input cssClass="form-control input-sm" path="lastName" id="lastName" maxlength="50"/>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
                ...
                <form:input cssClass="form-control input-sm" path="email" id="email"/>
                <form:errors path="email" cssClass="help-block"/>
            </div>
            <div class="col-sm-6 form-group">
                <appfuse:label styleClass="control-label" key="user.phoneNumber"/>
                <form:input cssClass="form-control input-sm" path="phoneNumber" id="phoneNumber"/>
            </div>
        </div>
        <div class="form-group">
            <appfuse:label styleClass="control-label" key="user.website"/>
            <form:input cssClass="form-control input-sm" path="website" id="website"/>
        </div>
        <div>
            ...
            <div id="collapse-address" class="accordion-body collapse">
                ...
                <div class="row">
                    <div class="col-sm-7 form-group">
                        ...
                        <form:input cssClass="form-control input-sm" path="address.city" id="address.city"/>
                    </div>
                    <div class="col-sm-2 form-group">
                        <appfuse:label styleClass="control-label" key="user.address.province"/>
                        <form:input cssClass="form-control input-sm" path="address.province" id="address.province"/>
                    </div>
                    <div class="col-sm-3 form-group">
                        <appfuse:label styleClass="control-label" key="user.address.postalCode"/>
                        <form:input cssClass="form-control input-sm" path="address.postalCode" id="address.postalCode"/>
                    </div>
                </div>
                <div class="form-group">
...
<c:choose>
    <c:when test="${param.from == 'list' or param.method == 'Add'}">
        ...
        <div class="form-group">
            ...
            <select id="userRoles" name="userRoles" multiple="true" class="form-control input-sm">
