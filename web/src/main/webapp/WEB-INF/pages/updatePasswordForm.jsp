...
<div class="col-sm-5">
	<form method="post" id="updatePassword" action="<c:url value='/updatePassword'/>" class="well" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input type="text" name="username" class="form-control input-sm" id="username" value="<c:out value="${username}" escapeXml="true"/>" required>
        </div>
	    ...
	    <c:choose>
	    	...
	    	<c:otherwise>
		        <div class="form-group">
                    ...
                    <input type="password" class="form-control input-sm" name="currentPassword" id="currentPassword" required autofocus>
		        </div>
	    	</c:otherwise>
	    </c:choose>
